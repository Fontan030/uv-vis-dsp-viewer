...
t = gettext.translation(domain='messages', localedir='locale', languages=['kk'], fallback=True)  
_ = t.gettext
nm_label = _('nm')
...
help_menu = tk.Menu()
help_menu.add_command(label=_('About'), command=show_help)
main_menu = tk.Menu()
